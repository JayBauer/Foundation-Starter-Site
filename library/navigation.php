 ...
 */
if ( ! function_exists( 'jaybauerstarter_top_bar_r' ) ) {
	function jaybauerstarter_top_bar_r() {
		wp_nav_menu( array(
			'container'      => false,
 ...
 */
if ( ! function_exists( 'jaybauerstarter_mobile_nav' ) ) {
	function jaybauerstarter_mobile_nav() {
		wp_nav_menu( array(
...
*/
if ( ! function_exists( 'jaybauerstarter_add_menuclass' ) ) {
	function jaybauerstarter_add_menuclass( $ulclass ) {
		$find = array('/<a rel="button"/', '/<a title=".*?" rel="button"/');
		$replace = array('<a rel="button" class="button"', '<a rel="button" class="button"');

		return preg_replace( $find, $replace, $ulclass, 1 );
	}
	add_filter( 'wp_nav_menu','jaybauerstarter_add_menuclass' );
}
...
if ( ! function_exists( 'jaybauerstarter_breadcrumb' ) ) {
	function jaybauerstarter_breadcrumb( $showhome = true, $separatorclass = false ) {
